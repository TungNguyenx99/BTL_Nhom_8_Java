...
INSERT INTO NguoiDung(MaND, TenND, Tuoi, SoDT, GioiTinh, DiaChi, ChucVu, UserName, UserPass, Hinh) VALUES
	('NV01', N'Phạm Minh Phương', 21, '0787165356', 1, N'Tràng An, Ninh Bình', N'Quản Lý', 'superadmin', '12345678', NULL),
	('NV02', N'Nguyễn Văn Thành', 21, '0814941156', 1, N'Đông Anh, Hà Nội', N'Nhân Viên', 'admin1', '1234567', NULL),
	('NV03', N'Mạc Duy Khánh', 21, '0844657355', 1, N'Thanh Xuân, Hà Nội', N'Nhân Viên', 'admin2', '1234567', NULL),
	('NV04', N'Nguyễn Hoàng Tùng', 21, '0978554147', 1, N'Ba Bình, Hà Nội', N'Nhân Viên', 'admin3', '1234567', NULL),
	('NV05', N'Nguyễn Hữu Nghĩa', 21, '0369884725', 1, N'Thanh Xuân, Hà Nội', N'Nhân Viên', 'admin4', '1234567', NULL);
...
INSERT INTO KhachHang(MaKH, HoTen, GioiTinh, CMND, DienThoai, NgaySinh, Email, DiaChi) VALUES
	('KH001', N'Mạc Văn Khoa', 0, 184415300, 0977468155,'1/1/2000','vankhoa@gamil.com', N'Đống Đa - Hà Nội'),
	('KH002', N'Mai Phương Anh', 0, 184415334, 0977468345,'4/6/2000','phuonganh@gmail.com', N'Phủ Lý - Hà Nam'),
	('KH003', N'Nguyễn Văn Tài', 0, 124538200, 0977462355,'2/3/2000', 'vantai@gmail.com', N'Ba Đình - Hà Nội'),
	('KH004', N'Bùi Văn Dương', 1, 184415654, 0351748741,'2/25/2000', 'vanduong@gmail.com', N'Đông Anh - Hà Nội'),
	('KH005', N'Phí Thị Mỹ Duyên', 1, 184415654, 0985574120,'10/10/2000', 'myduyen@gmail.com', N'Thanh Xuân - Hà Nội');
...
INSERT INTO ThongTinXe(BienSo, MaXM, MaOT, MaXT, NgayDangKy, TinhTrang) VALUES
	('38N1-2341','XM01', null, null, '2/3/2019', N'Hoạt đông tốt'),
	('38N1-2342','XM02', null, null, '2/3/2019', N'Hoạt đông tốt'),
	('38N1-2343','XM03', null, null, '2/3/20120', N'Hoạt đông tốt'),
	('24N1-2344',null, 'OT01', null, '6/3/2018', N'Hoạt đông tốt'),
	('24N1-2345',null, 'OT02', null, '6/3/2016', N'Hoạt đông tốt'),
...
INSERT INTO PhieuThue(MaPT, NgayThue, MaKH, MaND, SoNgayThue, BienSo, DonGiaNgay) VALUES
	('PT01', '26/11/2021', 'KH001', 'NV01', 5,'38N1-2341', 100000),
	('PT02', '15/9/2021', 'KH002', 'NV02', 7, '24N1-2345', 200000),
	('PT03', '9/1/2021', 'KH003', 'NV03', 4, '35N1-2348', 300000),
	('PT04', '24/7/2021', 'KH004', 'NV04', 4, '35N1-2347', 400000),
	('PT05', '30/10/2021', 'KH005', 'NV05', 4, '38N1-2344', 500000);
